var watermark,body, version_history_container,version_history_grid_container, version_history_close_button, version_history_info_button, version_history_innerHTML, flyin;
...
function flyin_open(content){ //Öffnen eines Flyin-Fensters: flyin_open([content]) --> [content] muss html als String sein
  flyin = true;
  if(version_history_container.classList.contains("version_history_opened")){//Experimentell: Wenn schon geöffnet
    flyin_close("flyin", content);
  }else{
...
function flyin_close(origin, content){
